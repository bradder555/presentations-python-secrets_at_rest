...
The [`standalone.Dockerfile`](Dockerfile) example extends the `multistage.Dockerfile`
...
[`src/uv_docker_example/__init__.py`](src/app/__init__.py) — there's a command line
